...
$query = "SELECT * FROM ${prefix}field_data_body WHERE body_value != '' AND entity_id in (189,190,191,192,195,196,197,198,199,200,201,202,203,209,210,213,214,215,216,217,218,219,220)";
...
//     $update_query = "UPDATE field_data_body SET body_format = 3";
//     echo $update_query;
//     mysql_query($update_query);
